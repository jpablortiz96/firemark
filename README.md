...
The multimodal checkpoint proves one Gemini PNG and one ElevenLabs MP3 without using OpenAI or an
...
The Gemini checkpoint verifies its embedded public PNG capsule. The ElevenLabs checkpoint confirms
