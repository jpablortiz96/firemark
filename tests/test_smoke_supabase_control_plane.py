...
def test_public_projection_requires_exact_allowlist_and_rejects_private_leaks() -> None:
    ...
    row = {
        ...
        "provider": evidence.generation_run.provider,
        "model": evidence.generation_run.model,
        "media_type": evidence.asset.asset_type,
        "mime_type": evidence.asset.media_type,
        "byte_size": evidence.asset.byte_size,
        "ai_generated": evidence.generation_run.ai_generated,
        "width": evidence.asset.width,
        "height": evidence.asset.height,
        "duration_ms": evidence.asset.duration_ms,
